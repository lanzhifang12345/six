$(function(){
	...
	$('.left-nav-uls .li10').click(function(){
		console.log(1);
		$('html,body').animate({
				'scrollTop':'0px'
		},200)
	...
	$('.index-bar-right .bar-uls .seven').click(function(){
		console.log(1);
		$('html,body').animate({
				'scrollTop':'0px'
		},200)
	...
	$('#upuls>li').mouseenter(function(){
		...
		var up=$(this).index();
		$('.updivs>div').eq(up).addClass('up-div3');
		$('.updivs>div').eq(up).siblings('div').removeClass('up-div3');
	})
